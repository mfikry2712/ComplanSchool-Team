...
class FragmentStatusFasilitas : Fragment() {

    private var _binding: FragmentStatusFasilitasBinding? = null
    ...
    private val adapterObs = MutableLiveData<AdapterStatusFasilitas>()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentStatusFasilitasBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        msgRef.observe(requireActivity()){
            ...
            if (it != null) {
                ...
                adapterObs.value = AdapterStatusFasilitas(options)
            }
        }
